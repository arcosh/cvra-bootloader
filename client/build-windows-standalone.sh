...
for script in invoke read_config write_config change_id bootloader_flash run_application; do
	rm build/$script -fr
	rm dist/$script.exe
...
for exe in invoke read_config write_config change_id run_application; do
