...
#define GPIOA_LED GPIO1
#define GPIOA_CAN_SPEED GPIO4
#define GPIOB_CAN_RX GPIO8
#define GPIOB_CAN_TX GPIO9
...
void platform_main(int arg)
{
    ...
    // CAN pin
    gpio_mode_setup(GPIOB, GPIO_MODE_AF, GPIO_PUPD_NONE, GPIOB_CAN_RX | GPIOB_CAN_TX);
    gpio_set_output_options(GPIOB, GPIO_OTYPE_PP, GPIO_OSPEED_100MHZ, GPIOB_CAN_RX | GPIOB_CAN_TX);
    gpio_set_af(GPIOB, GPIO_AF9, GPIOB_CAN_RX | GPIOB_CAN_TX);

    // enable CAN transceiver
    gpio_mode_setup(GPIOA, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GPIOA_CAN_SPEED);
    gpio_set_output_options(GPIOA, GPIO_OTYPE_PP, GPIO_OSPEED_100MHZ, GPIOA_CAN_SPEED);
    gpio_clear(GPIOA, GPIOA_CAN_SPEED);
